    ...
    <div className="fade-in">
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          description={canCreate ? 'Crie seu primeiro projeto para começar' : 'Nenhum projeto disponível'}
          action={canCreate && <button onClick={() => setShowModal(true)} className="btn-primary">Novo Projeto</button>}
        />
      ) : (
            ...
            <Link key={p.id} to={`/app/projects/${p.id}`}
              ...
              {p.cover_url ? (
                ...
                <div className="w-full h-40 flex items-center justify-center"
                  style={{ borderRadius: '24px 24px 0 0', background: 'linear-gradient(135deg, rgba(124,92,252,0.20), rgba(124,92,252,0.05))' }}>
              ...
              <div className="p-5">
                ...
                <div className="flex items-start justify-between gap-2 mb-1.5">
                  <h3 className="text-sm font-bold leading-snug line-clamp-2 flex-1"
                    style={{ color: 'var(--text-primary)' }}>
                    {p.title}
                  </h3>
